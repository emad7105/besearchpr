...
public class LinkGraphReducer extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
	...
	public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
		...
		toReturn.append(String.valueOf(incoming.size())).append(",");
		...
		toReturn.append(">,<");
		toReturn.append(String.valueOf(outgoing.size())).append(",");
	 ...
	 * @param outgoing
	 */
	private void fill_incoming_outgoing(Iterator<Text> values, ArrayList<String> incoming, ArrayList<String> outgoing) {
