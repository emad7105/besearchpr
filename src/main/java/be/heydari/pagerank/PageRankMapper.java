		...
		if (matcherLineRegEx.matches()) {
			...
			if (noOfInHtmls != 0) {
				...
				while (matcherHtmlSeparator.find()) {
					...
					newValue = "<out>" + "<" + baseHtml + ">" + "<" + Float.toString(1 / Commons.TOTAL_PAGES) + ">" + "<" + Integer.toString(noOfOutHtmls) + "><" + Float.toString(1 / Commons.TOTAL_PAGES) + ">";
//					newValue = "<out>" + "<" + baseHtml + ">" + "<" + Float.toString(1/CommonMethods.TOTAL_PAGES) + ">" + "<" + Integer.toString(noOfOutHtmls) + ">";
			...
			if (noOfOutHtmls != 0) {
				...
				while (matcherHtmlSeparator.find()) {
					...
					keyValue = matcherHtmlSeparator.group(2);
					newValue = "<in>" + "<" + baseHtml + ">" + "<" + Double.toString(1 / Commons.TOTAL_PAGES) + ">" + "<" + Integer.toString(noOfOutHtmls) + "><" + Float.toString(1 / Commons.TOTAL_PAGES) + ">";
